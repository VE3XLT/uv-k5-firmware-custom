...
ENABLE_FEAT_F4HWN             := 1       improve screen setbrigtness at boot, improve power settings level (Low ~0.5W, Mid ~2W and High ~5W), improve smeter, improve menu index, add Set Low menu (125mW, 250mW, 500mW)
